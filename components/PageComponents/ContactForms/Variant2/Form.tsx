        ...
        <div className={styles.card}>
          ...
          <div className={styles.leftPanel}>
            <div className={styles.panelInner}>
              ...
              <span className={styles.quoteAttrib}>— Keyline Locksmith, Waco TX</span>
              ...
              <div className={styles.panelBadges}>
                {['Same-Day Available', '2-Year Warranty', 'No Contracts', 'Licensed Locksmith'].map(b => (
              ...
              {submitted ? (
                ...
                <motion.div key="form" initial={{ opacity: 0, y: 12 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.4 }}>
                  <div className={styles.formHead}>
                    <span className={styles.eyebrow}>Schedule Service · Get Help Now</span>
                  ...
                  <form className={styles.form} onSubmit={handleSubmit} noValidate>
                    ...
                    <button type="submit" disabled={isSubmitting} className={styles.submitBtn}>
                      {isSubmitting
                        ...
                        : <><span>Book Get Help Now</span><FontAwesomeIcon icon={faArrowRight} /></>}
                    </button>
                  </form>
                </motion.div>
              )}
