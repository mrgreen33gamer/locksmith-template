...
const DEFAULT_GUARANTEES: Guarantee[] = [
  ...
  {
    icon: faShieldHalved,
    title: "24/7 Emergency Response · Workmanship Guaranteed",
    description:
  ...
  {
    icon: faCertificate,
    title: "Licensed Locksmith · Bonded & Insured",
    description:
      "Every locksmith technician who enters your home is licensed. No unlicensed subs working alone — ever.",
  },
  {
      ...
      <div className={styles.container}>
        ...
        <div className={styles.leftCol}>
          ...
          <p className={styles.body}>
            Every locksmith company in Central Texas makes promises. We back ours in writing — with flat-rate pricing, licensed locksmith technicians, and a 24/7 Emergency Response · Workmanship Guaranteed on every install we touch.
          </p>
          <Link
            href={ctaLink}
