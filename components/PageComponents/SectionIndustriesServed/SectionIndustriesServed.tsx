...
const INDUSTRIES = [
  ...
  { slug: 'auto-dealers',        label: 'Auto Dealers & Fleets', icon: faHardHat },
  { slug: 'retail-security',     label: 'Retail Security',       icon: faIndustry },
];
...
export default function SectionIndustriesServed({
  ...
  subtitle = 'Locksmith and access programs — built for how your industry actually works.',
  disableLinks = false,
