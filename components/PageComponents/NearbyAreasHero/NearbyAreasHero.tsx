...
export default function NearbyAreasHero({
  ...
  const displayHeadline = headline ?? `Locksmith Service in ${cityName}, TX`;
  const displayDesc     = description ??
    `Keyline Locksmith provides fast, reliable locksmith service to ${cityName} and all surrounding communities. Licensed locksmiths, flat-rate pricing, workmanship guaranteed on every job.`;
    ...
    <section className={styles.section}>
      ...
      <div className={styles.container}>
        ...
        >
          ...
          <a href="tel:+12548202020" className={styles.phoneBtn}>
            <svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round">
