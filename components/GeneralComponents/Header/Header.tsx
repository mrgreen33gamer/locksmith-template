...
const logoName = 'Keyline Locksmith';
const logoTagline = 'Lockouts · Locks · Keys · Security';
const navLinks = [
  { href: '/', label: 'Home' },
...
const phoneDisplay = '(254) 820-2020';
const phoneHref = 'tel:+12548202020';
const ctaLabel = 'Get Help Now';
