  ...
  return (
    <section className={styles.banner} aria-label="Call to action">
      ...
      <motion.div
        ...
        aria-hidden="true"
      >
        <svg width="400" height="400" viewBox="0 0 24 24" fill="currentColor"><path d="M7 14a5 5 0 1 1 4.9-6H22v3h-2v3h-3v-3h-2.1A5 5 0 0 1 7 14zm0-3a2 2 0 1 0 0-4 2 2 0 0 0 0 4z" opacity="0.85"/></svg>
      </motion.div>
