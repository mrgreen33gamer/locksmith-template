...
const LocalCitationBlock: React.FC<LocalCitationBlockProps> = ({
  businessName  = 'Keyline Locksmith',
  address       = '1201 Speight Ave, Waco, TX 76706',
  phone         = '(254) 820-2020',
  email         = 'hello@keylinelocksmith.com',
  googleMapsUrl = 'https://maps.google.com/?q=Keyline+Locksmith+Waco+TX',
  hours         = DEFAULT_HOURS,
  cityName      = 'Waco',
}) => {
  return (
      ...
      <div className={styles.container}>
        ...
        <div className={styles.header}>
          ...
          <p className={styles.subtitle}>
            Based in {cityName}, TX — serving all of Central Texas with licensed locksmith technicians.
          </p>
        </div>
