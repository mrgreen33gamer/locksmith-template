...
const BlogPreviewGrid: React.FC<BlogPreviewGridProps> = ({
  title       = 'Locksmith Tips & Insights',
  subtitle    = 'Practical advice for Central Texas homeowners — lockouts, rekeys, smart locks, and staying secure.',
  posts,
  count       = 4,
  viewAllLink = '/blogs',
